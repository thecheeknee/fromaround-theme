...
<article>
        ...
        <nav class="no-shadow white">
            <div class="full-width">
                <ul class="brdcrumb">
                    ...
                    <li>
                        <a class="black-text tiny"><span class="hide-on-med-and-down"><?php the_title(); ?></span><span class="show-on-med-and-down">Post</span></a>
                    </li>
                </ul>
            </div>
        </nav>
    ...
    <div class="page-wrapper full-width rel-div div-center">
        <div class="post-header-wrapper grey darker-3 full-width rel-div header-height valign-wrapper">
            <div class="abs-div full-width header-height header-image" style="background-image: url(<?php echo $post_image; ?>);"></div>
            <header class="header-height abs-div full-width valign-wrapper">
                <div class="title-wrapper full-width scrollblock">
                    <p class="white-text uppercase center-align"><?php echo $category->slug; ?></p>
                    <h1 class="white-text center-align mgblock margin-top thicker"><?php the_title(); ?></h1>
                    <p class="white-text uppercase mgblock margin-top center-align"><i class="material-icons">access_time</i> <?php echo get_the_date( 'M j Y' ); ?></p>
                </div>
            </header>
        </div>
    </div>
        ...
        <div class="post-content margin-top center-align grey-text text-darken-4">
            <div class="scrollblock text-wrapper">
                <div class="center mgblock page-wrapper div-center">
                    <h4 class="center thicker"><?php the_title(); ?></h4>
					<div id="textbyBlock">
					</div>
					<p class="black-text uppercase center-align"><i class="material-icons">access_time</i> <?php echo get_the_date( 'M j Y' ); ?></p>
                    <div class="container intro-block div-center">
